...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-hiaxs3o.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-hiaxs3o.containers.anotherwebservice.com/
...
```
git clone git@github.com:jaccky22/container-hiaxs3o.git
cd container-hiaxs3o
```
...
```
docker attach container-hiaxs3o
```
